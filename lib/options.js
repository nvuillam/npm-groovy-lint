...
const defaultServerPort = process.env.SERVER_PORT
...
export const optionsDefinition = optionator({
  ...
  options: [
    ...
    },
    {
      ...
      dependsOn: ["source"],
      description:
        "Full path of the file whose content is sent in source argument ",
      example: [
        "C:/some/folder/myScript.groovy",
        "/var/some/folder/myScript.groovy",
      ],
    },
    {
      option: "parse",
      type: "Boolean",
      description:
        "Try to parse the source code with GroovyShell and return errors (use argument --no-parse if you want to deactivate)",
    },
    {
      option: "config",
      alias: "c",
    ...
    },
    {
      ...
      dependsOn: ["fix"],
      description:
        "Option for --fix argument: List of rule identifiers to fix (if not specified, all available fixes will be applied)",
    ...
    },
    {
      ...
      dependsOn: ["fix"],
      description:
        "Option for --fix argument: Comma-separated list of rule identifiers to exclude from fixes (if not specified, none are excluded). Can be combined with --fixrules",
      example: [
        "Indentation,IndentationClosingBraces",
        "UnnecessarySemicolon,SpaceAfterComma",
      ],
    },
    {
      ...
      type: "String",
      description:
        "Comma-separated list of Ant-style file patterns specifying files that must be ignored. Default: none",
      example: ["**/test/*"],
    },
    {
      option: "rulesets",
    ...
    },
    {
      ...
      default: "txt",
      description:
        "Output format (txt,json,sarif,html,xml), or path to a file with one of these extensions",
      example: [
        "txt",
        "json",
        "sarif",
    ...
    },
    {
      ...
      description:
        "If use of CodeNarc server, host where is the CodeNarc server (default: localhost)",
    },
    {
      option: "serverport",
      type: "String",
    ...
    },
    {
      ...
      default: "java",
      description:
        "If you do not want to use default java executable to run CodeNarcServer, you can override it",
      example: [
        `C:\\Program Files\\Java\\jdk1.8.0_144\\bin\\java.exe`,
        `/users/nvuillam/jdk1.8.0_144/bin/java`,
      ],
    },
    {
      option: "javaoptions",
    ...
    },
    {
      ...
      type: "Boolean",
      description:
        "Do not lint again after format and fix options (useful for client calling Npm Groovy Lint)",
    },
    {
      option: "returnrules",
      type: "Boolean",
    ...
    },
    {
      ...
      type: "Boolean",
      description:
        "Show help (npm-groovy-lint -help OPTIONNAME to see option detail)",
    },
    {
      option: "version",
      alias: "v",
    ...
    },
    {
      ...
      default: ".",
      description:
        "(DEPRECATED) Directory containing the files to lint (default: current directory)",
    ...
    },
    {
      ...
      type: "String",
      description:
        "(DEPRECATED) Comma-separated list of Ant-style file patterns specifying files that must be included",
