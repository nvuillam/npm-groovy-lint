...
export const optionsDefinition = optionator({
    ...
    options: [
        ...
        },
        {
            ...
            default: process.cwd(),
            description:
                "Custom path to directory containing GroovyLint config file, or the name of a bundled preset (recommended, advanced, all, format, grails, tests, jenkinsfile, recommended-jenkinsfile).\n Default: Found groovylintrc.js/json/yml/package.json config file, or default npm-groovy-lint config if not defined. \nNote: command-line arguments have priority on config file properties",
            example: ["./config", "./config/whatever", "advanced", "recommended-jenkinsfile"],
        },
        {
            option: "format",
            type: "Boolean",
        ...
        },
        {
            ...
            description:
                "If use of CodeNarc server, host where is the CodeNarc server (default: 127.0.0.1, the server only listens on the IPv4 loopback)",
        },
        {
            option: "serverport",
            type: "String",
        ...
        },
        {
            option: "javaoptions",
            type: "String",
            default: "-Xms256m,-Xmx4096m",
            description: "Override java options",
            example: [`-Xms256m,-Xmx4096m`],
        },
        {
            option: "killserver",
            type: "Boolean",
        ...
        },
        {
            ...
            type: "Int",
            description:
                "Number of threads used to analyse files in parallel (default: auto, max 4). Use 1 to disable. Applies only when using the CodeNarc server (the default); has no effect with --noserver.",
        },
    ],
    mutuallyExclusive: [
