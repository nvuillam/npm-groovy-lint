...
class CodeNarcCaller {
    ...
    javaCallerOptions = {
        ...
        codeNarcJava: {
            ...
            classPath:
                "java/CodeNarc-3.1.0-groovy-4.0.jar:java/groovy/lib/groovy-4.0.6.jar:java/groovy/lib/groovy-templates-4.0.6.jar:java/groovy/lib/groovy-xml-4.0.6.jar:java/groovy/lib/groovy-json-4.0.6.jar:java/groovy/lib/groovy-ant-4.0.6.jar:java/groovy/lib/ant-1.10.12.jar:java/groovy/lib/ant-launcher-1.10.12.jar:java/slf4j-api-1.7.9.jar:java/log4j-slf4j-impl-2.18.0.jar:java/log4j-api-2.18.0.jar:java/log4j-core-2.18.0.jar:java/GMetrics-2.1.0.jar:java/*"
        }
    };
            ...
            if (!secondAttempt) {
                ...
                if (
                    ...
                    await new Promise(resolve => {
                        findJavaHome({ allowJre: true }, (err) => {
                            if (err) {
                                reason =
