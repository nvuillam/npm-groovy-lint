...
class CodeNarcCaller {
    ...
    javaCallerOptions = {
        ...
        codeNarcJava: {
            ...
            classPath:
                "java/CodeNarc-2.1.0.jar:java/groovy/lib/groovy-3.0.8.jar:java/groovy/lib/groovy-templates-3.0.8.jar:java/groovy/lib/groovy-xml-3.0.8.jar:java/groovy/lib/groovy-json-3.0.8.jar:java/groovy/lib/groovy-ant-3.0.8.jar:java/groovy/lib/ant-1.10.9.jar:java/groovy/lib/ant-launcher-1.10.8.jar:java/slf4j-api-1.7.9.jar:java/log4j-slf4j-impl-2.13.0.jar:java/log4j-api-2.13.0.jar:java/log4j-core-2.13.0.jar:java/gmetrics-1.1.jar:java/*"
        }
    };
